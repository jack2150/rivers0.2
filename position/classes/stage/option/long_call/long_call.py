...
class StageLongCall(object):
    ...
    def create_profit_stage(self):
        ...
        profit_stage.price_a = self.call_order.strike + self.call_order.price
    ...
    def create_loss_stage(self):
        ...
        loss_stage.price_b = self.call_order.strike + self.call_order.price
