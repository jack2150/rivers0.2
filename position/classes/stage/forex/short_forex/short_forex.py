...
class StageShortForex(object):
    ...
    def create_even_stage(self):
        ...
        even_stage.stage_expression = '%.4f == {price}' % self.forex_order.price
    ...
    def create_profit_stage(self):
        ...
        profit_stage.stage_expression = '{price} < %.4f' % self.forex_order.price
    ...
    def create_loss_stage(self):
        ...
        loss_stage.stage_expression = '%.4f < {price}' % self.forex_order.price
