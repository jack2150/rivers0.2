...
class TestStageShortFuture(TestUnitSetUpStage):
    ...
    def test_create_even_stage(self):
        ...
        self.assertEqual(even_stage.stage_expression, '484.25 == {price}')
        self.assertEqual(float(even_stage.price_a), 484.25)
    ...
    def test_create_profit_stage(self):
        ...
        self.assertEqual(profit_stage.stage_expression, '{price} < 484.25')
        self.assertEqual(float(profit_stage.price_a), 484.25)
    ...
    def test_create_loss_stage(self):
        ...
        self.assertEqual(loss_stage.stage_expression, '484.25 < {price}')
        self.assertEqual(float(loss_stage.price_a), 484.25)
