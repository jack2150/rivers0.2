...
class StageLongFuture(object):
    ...
    def create_profit_stage(self):
        ...
        profit_stage.stage_expression = '%.2f < {price}' % self.future_order.price
    ...
    def create_loss_stage(self):
        ...
        loss_stage.stage_expression = '{price} < %.2f' % self.future_order.price
