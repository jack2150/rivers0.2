...
class TestStageLongStock(TestUnitSetUpStage):
    ...
    def test_create_even_stage(self):
        ...
        self.assertEqual(even_stage.stage_expression, '%.2f == {price}' % self.stock_order.price)
        self.assertEqual(float(even_stage.price_a), self.stock_order.price)
    ...
    def test_create_profit_stage(self):
        ...
        self.assertEqual(profit_stage.stage_expression, '%.2f < {price}' % self.stock_order.price)
        self.assertEqual(float(profit_stage.price_a), self.stock_order.price)
    ...
    def test_create_loss_stage(self):
        ...
        self.assertEqual(float(loss_stage.price_a), self.stock_order.price)
