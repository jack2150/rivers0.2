...
class StageLongCallVertical(object):
    ...
    def create_profit_stage(self):
        ...
        profit_stage.price_a = self.buy_order.strike + self.buy_order.price - self.sell_order.price
    ...
    def create_loss_stage(self):
        ...
        loss_stage.price_b = self.buy_order.strike + self.buy_order.price - self.sell_order.price
