...
class StageShortCombo(Stage):
    ...
    def create_max_profit_stage(self):
        ...
        max_profit_stage.amount_a = (
            self.net_price * self.call_order.quantity * self.contract_right
        )
        ...
        max_profit_stage.left_expression = self.e_price_range_higher
        max_profit_stage.right_expression = self.e_price_range_lower
    ...
    def create_max_loss_stage(self):
        ...
        max_loss_stage.left_expression = self.e_price_range_lower
        max_loss_stage.right_expression = self.e_price_range_higher
    ...
    def create_profit_stage2(self):
        ...
        if self.net_price >= 0:
            ...
            profit_stage.price_a = self.put_order.strike
            profit_stage.amount_a = (
                self.net_price * self.call_order.quantity * self.contract_right * -1
            )
