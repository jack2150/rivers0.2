...
class TestStageShortPutBackratio2(TestUnitSetUpStage):
    def setUp(self):
        TestUnitSetUpStage.setUp(self)
    ...
    def test_create_max_profit_stage1(self):
        ...
        self.check_in_stage(stage_cls=max_profit_stage, price=18, expect=True)
        self.check_in_stage(stage_cls=max_profit_stage, price=19, expect=False)

        print '\n' + ':' * 80 + '\n'

        self.check_get_status(max_profit_stage, new_price=18, old_price=18, expect='unknown')
    ...
    def test_create_loss_stage1(self):
        ...
        self.check_in_stage(stage_cls=loss_stage, price=15, expect=True)
        self.check_in_stage(stage_cls=loss_stage, price=16.5, expect=False)

        print '\n' + ':' * 80 + '\n'

        self.check_get_status(loss_stage, new_price=15, old_price=14.5, expect='recovering')
        self.check_get_status(loss_stage, new_price=13, old_price=15, expect='losing')
        self.check_get_status(loss_stage, new_price=16, old_price=16, expect='unknown')
    ...
    def test_create_profit_stage1(self):
        ...
        self.check_in_stage(stage_cls=profit_stage, price=17, expect=True)
        self.check_in_stage(stage_cls=profit_stage, price=18.5, expect=False)

        print '\n' + ':' * 80 + '\n'

        self.check_get_status(profit_stage, new_price=16.8, old_price=17, expect='decreasing')
        self.check_get_status(profit_stage, new_price=17.5, old_price=17, expect='profiting')
        self.check_get_status(profit_stage, new_price=17, old_price=17, expect='unknown')
    ...
    def test_create_profit_stage2(self):
        ...
        self.check_in_stage(stage_cls=profit_stage, price=19.5, expect=True)
        self.check_in_stage(stage_cls=profit_stage, price=20, expect=False)

        print '\n' + ':' * 80 + '\n'

        self.check_get_status(profit_stage, new_price=19.3, old_price=18.6, expect='decreasing')
        self.check_get_status(profit_stage, new_price=18.5, old_price=19.2, expect='profiting')
        self.check_get_status(profit_stage, new_price=18.5, old_price=18.5, expect='unknown')

    def test_create_loss_stage2(self):
        """
        Create loss stage using filled orders data
        """
        loss_stage = self.short_put_backratio.create_loss_stage2()
        self.method_test_create_stage(
            stage=loss_stage,
            name='LOSS',
        ...
        self.check_in_stage(stage_cls=loss_stage, price=19.9, expect=True)
        self.check_in_stage(stage_cls=loss_stage, price=21, expect=False)

        print '\n' + ':' * 80 + '\n'

        self.check_get_status(loss_stage, new_price=19.95, old_price=19.98, expect='recovering')
        self.check_get_status(loss_stage, new_price=19.95, old_price=19.92, expect='losing')
        self.check_get_status(loss_stage, new_price=19.9, old_price=19.9, expect='unknown')

    def test_create_max_loss_stage(self):
        """
        Create max loss stage using filled orders data
        """
        max_loss_stage = self.short_put_backratio.create_max_loss_stage()
        self.method_test_create_stage(
        ...
        self.check_in_stage(stage_cls=max_loss_stage, price=21, expect=True)
        self.check_in_stage(stage_cls=max_loss_stage, price=19, expect=False)

        print '\n' + ':' * 80 + '\n'

        self.check_get_status(max_loss_stage, new_price=20.5, old_price=21, expect='easing')
        self.check_get_status(max_loss_stage, new_price=22, old_price=21, expect='worst')
        self.check_get_status(max_loss_stage, new_price=21, old_price=21, expect='unknown')
...
class TestStageShortPutBackratio3(TestUnitSetUpStage):
    def setUp(self):
        TestUnitSetUpStage.setUp(self)
    ...
    def test_create_even_stage2(self):
        ...
        Create even stage using filled orders data
        """
        even_stage = self.short_put_backratio.create_even_stage2()
        self.method_test_create_stage(
            stage=even_stage,
            name='EVEN',
    ...
    def test_create_max_profit_stage1(self):
        ...
        self.check_in_stage(stage_cls=max_profit_stage, price=355, expect=True)
        self.check_in_stage(stage_cls=max_profit_stage, price=345, expect=False)

        print '\n' + ':' * 80 + '\n'

        self.check_get_status(
            stage_cls=max_profit_stage, new_price=355, old_price=355, expect='unknown'
        )
    ...
    def test_create_loss_stage1(self):
        ...
        self.check_in_stage(stage_cls=loss_stage, price=320, expect=True)
        self.check_in_stage(stage_cls=loss_stage, price=331, expect=False)

        print '\n' + ':' * 80 + '\n'

        self.check_get_status(loss_stage, new_price=321, old_price=310, expect='recovering')
        self.check_get_status(loss_stage, new_price=315, old_price=320, expect='losing')
        self.check_get_status(loss_stage, new_price=320, old_price=320, expect='unknown')
    ...
    def test_create_profit_stage1(self):
        ...
        self.check_in_stage(stage_cls=profit_stage, price=340, expect=True)
        self.check_in_stage(stage_cls=profit_stage, price=360, expect=False)

        print '\n' + ':' * 80 + '\n'

        self.check_get_status(profit_stage, new_price=335, old_price=345, expect='decreasing')
        self.check_get_status(profit_stage, new_price=345, old_price=340, expect='profiting')
        self.check_get_status(profit_stage, new_price=341, old_price=341, expect='unknown')
